...
template <typename T>
__global__ void rmsnorm_twoPassAlgo_e1_fp8_none(T* output, const T* input, const T* weight,
                                                const int m, const int n, float ratio,
                                                float epsilon)
{
...
template <typename T>
__global__ void rmsnorm_twoPassAlgo_e1_fp8_pdl(T* output, const T* input, const T* weight,
...
template <typename T>
__global__ void rmsnorm_twoPassAlgo_e1_fp8_shared_mem(T* output, const T* input, const T* weight,
                                                      const int m, const int n, float ratio,
                                                      float epsilon)
{
...
template <typename T>
__global__ void rmsnorm_twoPassAlgo_e1_fp8_prefetch(T* output, const T* input, const T* weight,
                                                    const int m, const int n, float ratio,
                                                    float epsilon)
{
    const int tid = threadIdx.x;
